    ...
    <div className="relative mx-auto flex min-h-screen max-w-md flex-col bg-white dark:bg-[var(--color-background-dark)]">
      <div className="sticky top-0 z-10 glass-light px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Thông báo</h1>
        </div>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          Cập nhật đơn hàng, thưởng và tin nhắn.
        </p>
      </div>

      <div className="flex-1 px-6 py-4">
        <p className="text-sm text-slate-500 dark:text-slate-400">Chưa có thông báo mới.</p>
      </div>
    </div>
  );
}
