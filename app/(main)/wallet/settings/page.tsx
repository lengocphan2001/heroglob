    ...
    <div className="relative mx-auto flex min-h-screen max-w-md flex-col bg-white dark:bg-[var(--color-background-dark)]">
      <div className="sticky top-0 z-10 glass-light px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Cài đặt ví</h1>
        </div>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Cài đặt mạng, đơn vị tiền tệ và bảo mật.</p>
      </div>
      <div className="flex-1 px-6 py-4">
        <p className="text-sm text-slate-500 dark:text-slate-400">Tùy chọn cài đặt sẽ có trong phiên bản sau.</p>
      </div>
    </div>
  );
}
