...
import { LayoutDashboard, Users, Package, FolderTree, ShoppingBag, Settings, Banknote, Zap, CreditCard, GitBranch } from 'lucide-react';
...
export const navItems: NavItem[] = [
  ...
  { label: 'Cây phân cấp', path: '/referral-tree', icon: GitBranch },
